...
namespace Logliy\SpomkyLabs\Pki\ASN1\Type\Primitive;
...
use Logliy\SpomkyLabs\Pki\ASN1\Exception\DecodeException;
use Logliy\SpomkyLabs\Pki\ASN1\Feature\ElementBase;
use Logliy\SpomkyLabs\Pki\ASN1\Type\BaseString;
use Logliy\SpomkyLabs\Pki\ASN1\Type\PrimitiveType;
use Logliy\SpomkyLabs\Pki\ASN1\Type\UniversalClass;
use function chr;
