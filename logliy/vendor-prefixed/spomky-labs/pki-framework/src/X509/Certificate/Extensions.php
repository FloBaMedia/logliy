...
namespace Logliy\SpomkyLabs\Pki\X509\Certificate;
...
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\AuthorityKeyIdentifierExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\BasicConstraintsExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\CertificatePoliciesExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\CRLDistributionPointsExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\ExtendedKeyUsageExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\Extension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\InhibitAnyPolicyExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\IssuerAlternativeNameExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\KeyUsageExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\NameConstraintsExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyConstraintsExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\PolicyMappingsExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectAlternativeNameExtension;
use Logliy\SpomkyLabs\Pki\X509\Certificate\Extension\SubjectKeyIdentifierExtension;
use Traversable;
use function count;
