...
namespace Logliy\Symfony\Component\PropertyInfo\Extractor;

use Logliy\Symfony\Component\PropertyInfo\PropertyAccessExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\PropertyInitializableExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\PropertyListExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\PropertyReadInfo;
use Logliy\Symfony\Component\PropertyInfo\PropertyReadInfoExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\PropertyTypeExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\PropertyWriteInfo;
use Logliy\Symfony\Component\PropertyInfo\PropertyWriteInfoExtractorInterface;
use Logliy\Symfony\Component\PropertyInfo\Type as LegacyType;
use Logliy\Symfony\Component\String\Inflector\EnglishInflector;
use Logliy\Symfony\Component\String\Inflector\InflectorInterface;
...
use Logliy\Symfony\Component\TypeInfo\TypeResolver\ReflectionParameterTypeResolver;
use Logliy\Symfony\Component\TypeInfo\TypeResolver\ReflectionPropertyTypeResolver;
use Logliy\Symfony\Component\TypeInfo\TypeResolver\ReflectionReturnTypeResolver;
use Logliy\Symfony\Component\TypeInfo\TypeResolver\ReflectionTypeResolver;
use Logliy\Symfony\Component\TypeInfo\TypeResolver\TypeResolver;
use Logliy\Symfony\Component\TypeInfo\TypeResolver\TypeResolverInterface;
...
class ReflectionExtractor implements PropertyListExtractorInterface, PropertyTypeExtractorInterface, PropertyAccessExtractorInterface, PropertyInitializableExtractorInterface, PropertyReadInfoExtractorInterface, PropertyWriteInfoExtractorInterface, ConstructorArgumentTypeExtractorInterface
{
    ...
    {
        logliy_trigger_deprecation('symfony/property-info', '7.3', 'The "%s()" method is deprecated, use "%s::getType()" instead.', __METHOD__, self::class);
    ...
    {
        logliy_trigger_deprecation('symfony/property-info', '7.3', 'The "%s()" method is deprecated, use "%s::getTypeFromConstructor()" instead.', __METHOD__, self::class);
