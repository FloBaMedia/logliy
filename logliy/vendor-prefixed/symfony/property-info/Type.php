...
namespace Logliy\Symfony\Component\PropertyInfo;

logliy_trigger_deprecation('symfony/property-info', '7.3', 'The "%s" class is deprecated. Use "%s" class from "symfony/type-info" instead.', Type::class, \Logliy\Symfony\Component\TypeInfo\Type::class);
 ...
 *
 * @deprecated since Symfony 7.3, use "Logliy\Symfony\Component\TypeInfo\Type" class from "symfony/type-info" instead
 *
 * @final
 */
class Type
