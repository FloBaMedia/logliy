...
namespace Logliy\Symfony\Component\TypeInfo;

use Logliy\Symfony\Component\TypeInfo\Type\ArrayShapeType;
...
use Logliy\Symfony\Component\TypeInfo\Type\EnumType;
...
use Logliy\Symfony\Component\TypeInfo\Type\TemplateType;
...
trait TypeFactoryTrait
{
    ...
    {
        if ($asList) {
            logliy_trigger_deprecation('symfony/type-info', '7.3', 'The third argument of "%s()" is deprecated. Use the "%s::list()" method to create a list instead.', __METHOD__, self::class);
        }
