...
namespace Logliy\Symfony\Component\String;

use Logliy\Symfony\Component\String\Exception\ExceptionInterface;
use Logliy\Symfony\Component\String\Exception\InvalidArgumentException;
...
class UnicodeString extends AbstractUnicodeString
{
    ...
    public function __unserialize(array $data): void
    {
        if ($wakeup = self::class !== (new \ReflectionMethod($this, '__wakeup'))->class && self::class === (new \ReflectionMethod($this, '__unserialize'))->class) {
            logliy_trigger_deprecation('symfony/string', '7.4', 'Implementing "%s::__wakeup()" is deprecated, use "__unserialize()" instead.', get_debug_type($this));
        }
        ...
        try {
            ...
            logliy_trigger_deprecation('symfony/string', '7.4', 'Passing more than just key "string" to "%s::__unserialize()" is deprecated, populate properties in "%s::__unserialize()" instead.', self::class, get_debug_type($this));
    ...
    {
        logliy_trigger_deprecation('symfony/string', '7.4', 'Calling "%s::__wakeup()" is deprecated, use "__unserialize()" instead.', get_debug_type($this));
