...
namespace Logliy\Symfony\Component\Serializer\CacheWarmer;

use Symfony\Component\Filesystem\Filesystem;
use Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerInterface;
use Logliy\Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactoryCompiler;
use Logliy\Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactoryInterface;

logliy_trigger_deprecation('symfony/serializer', '7.3', 'The "%s" class is deprecated.', CompiledClassMetadataCacheWarmer::class);
