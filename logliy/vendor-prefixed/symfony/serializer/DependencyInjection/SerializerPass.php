...
namespace Logliy\Symfony\Component\Serializer\DependencyInjection;
...
use Logliy\Symfony\Component\Serializer\Debug\TraceableEncoder;
use Logliy\Symfony\Component\Serializer\Debug\TraceableNormalizer;
...
class SerializerPass implements CompilerPassInterface
{
    ...
    private function createNamedSerializerTags(ContainerBuilder $container, string $tagName, string $configName, array $namedSerializers): void
    {
        ...
        foreach ($container->findTaggedServiceIds($tagName) as $serviceId => $tags) {
            ...
            if (logliy_array_any($tags, $closure = static fn (array $tag) => (bool) $tag)) {
