...
if (!class_exists(\Logliy\Symfony\Component\Serializer\Annotation\Context::class, false)) {
    class_alias(Context::class, \Logliy\Symfony\Component\Serializer\Annotation\Context::class);
}
