...
if (!class_exists(\Logliy\Symfony\Component\Serializer\Annotation\Groups::class, false)) {
    class_alias(Groups::class, \Logliy\Symfony\Component\Serializer\Annotation\Groups::class);
}
