...
if (!class_exists(\Logliy\Symfony\Component\Serializer\Annotation\DiscriminatorMap::class, false)) {
    class_alias(DiscriminatorMap::class, \Logliy\Symfony\Component\Serializer\Annotation\DiscriminatorMap::class);
}
