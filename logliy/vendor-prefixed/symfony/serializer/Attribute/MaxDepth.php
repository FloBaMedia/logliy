...
if (!class_exists(\Logliy\Symfony\Component\Serializer\Annotation\MaxDepth::class, false)) {
    class_alias(MaxDepth::class, \Logliy\Symfony\Component\Serializer\Annotation\MaxDepth::class);
}
