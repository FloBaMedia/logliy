...
namespace Logliy\Symfony\Component\Serializer\Context\Normalizer;

use Logliy\Symfony\Component\Serializer\Context\ContextBuilderInterface;
use Logliy\Symfony\Component\Serializer\Context\ContextBuilderTrait;
...
abstract class AbstractNormalizerContextBuilder implements ContextBuilderInterface
{
    ...
    {
        logliy_trigger_deprecation('symfony/serializer', '7.1', 'The "%s()" method is deprecated, use "withDefaultConstructorArguments(?array $defaultConstructorArguments)" instead.', __METHOD__);
