...
namespace Logliy\Symfony\Component\Serializer\Context\Encoder;
...
final class CsvEncoderContextBuilder implements ContextBuilderInterface
{
    ...
    {
        logliy_trigger_deprecation('symfony/serializer', '7.2', 'The "%s" method is deprecated. It will be removed in 8.0.', __METHOD__);
