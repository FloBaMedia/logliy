...
namespace Logliy\phpDocumentor\Reflection;

use Logliy\Doctrine\Deprecations\Deprecation;
use InvalidArgumentException;
use Logliy\phpDocumentor\Reflection\PseudoTypes\ArrayShape;
use Logliy\phpDocumentor\Reflection\PseudoTypes\ArrayShapeItem;
use Logliy\phpDocumentor\Reflection\PseudoTypes\CallableString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\ConstExpression;
use Logliy\phpDocumentor\Reflection\PseudoTypes\False_;
use Logliy\phpDocumentor\Reflection\PseudoTypes\FloatValue;
use Logliy\phpDocumentor\Reflection\PseudoTypes\HtmlEscapedString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\IntegerRange;
use Logliy\phpDocumentor\Reflection\PseudoTypes\IntegerValue;
use Logliy\phpDocumentor\Reflection\PseudoTypes\List_;
use Logliy\phpDocumentor\Reflection\PseudoTypes\LiteralString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\LowercaseString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\NegativeInteger;
use Logliy\phpDocumentor\Reflection\PseudoTypes\NonEmptyList;
use Logliy\phpDocumentor\Reflection\PseudoTypes\NonEmptyLowercaseString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\NonEmptyString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\Numeric_;
use Logliy\phpDocumentor\Reflection\PseudoTypes\NumericString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\PositiveInteger;
use Logliy\phpDocumentor\Reflection\PseudoTypes\StringValue;
use Logliy\phpDocumentor\Reflection\PseudoTypes\TraitString;
use Logliy\phpDocumentor\Reflection\PseudoTypes\True_;
use Logliy\phpDocumentor\Reflection\Types\AggregatedType;
use Logliy\phpDocumentor\Reflection\Types\Array_;
use Logliy\phpDocumentor\Reflection\Types\ArrayKey;
use Logliy\phpDocumentor\Reflection\Types\Boolean;
use Logliy\phpDocumentor\Reflection\Types\Callable_;
use Logliy\phpDocumentor\Reflection\Types\CallableParameter;
use Logliy\phpDocumentor\Reflection\Types\ClassString;
use Logliy\phpDocumentor\Reflection\Types\Collection;
use Logliy\phpDocumentor\Reflection\Types\Compound;
use Logliy\phpDocumentor\Reflection\Types\Context;
use Logliy\phpDocumentor\Reflection\Types\Expression;
use Logliy\phpDocumentor\Reflection\Types\Float_;
use Logliy\phpDocumentor\Reflection\Types\Integer;
use Logliy\phpDocumentor\Reflection\Types\InterfaceString;
use Logliy\phpDocumentor\Reflection\Types\Intersection;
use Logliy\phpDocumentor\Reflection\Types\Iterable_;
use Logliy\phpDocumentor\Reflection\Types\Mixed_;
use Logliy\phpDocumentor\Reflection\Types\Never_;
use Logliy\phpDocumentor\Reflection\Types\Null_;
use Logliy\phpDocumentor\Reflection\Types\Nullable;
use Logliy\phpDocumentor\Reflection\Types\Object_;
use Logliy\phpDocumentor\Reflection\Types\Parent_;
use Logliy\phpDocumentor\Reflection\Types\Resource_;
use Logliy\phpDocumentor\Reflection\Types\Scalar;
use Logliy\phpDocumentor\Reflection\Types\Self_;
use Logliy\phpDocumentor\Reflection\Types\Static_;
use Logliy\phpDocumentor\Reflection\Types\String_;
use Logliy\phpDocumentor\Reflection\Types\This;
use Logliy\phpDocumentor\Reflection\Types\Void_;
use Logliy\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprFloatNode;
...
use Logliy\PHPStan\PhpDocParser\Ast\Type\ArrayShapeItemNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ArrayShapeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ArrayTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\CallableTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\CallableTypeParameterNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeForParameterNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ConditionalTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ConstTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\GenericTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\IdentifierTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\IntersectionTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\NullableTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\OffsetAccessTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\ThisTypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\TypeNode;
use Logliy\PHPStan\PhpDocParser\Ast\Type\UnionTypeNode;
use Logliy\PHPStan\PhpDocParser\Lexer\Lexer;
use Logliy\PHPStan\PhpDocParser\Parser\ConstExprParser;
use Logliy\PHPStan\PhpDocParser\Parser\ParserException;
use Logliy\PHPStan\PhpDocParser\Parser\TokenIterator;
use Logliy\PHPStan\PhpDocParser\Parser\TypeParser;
...
final class TypeResolver
{
    ...
    public function addKeyword(string $keyword, string $typeClassName): void
    {
        ...
        if (!in_array(Type::class, $interfaces, true)) {
            throw new InvalidArgumentException(
                'The class "' . $typeClassName . '" must implement the interface "Logliy\phpDocumentor\Reflection\Type"'
            );
        }
