...
namespace Logliy\phpDocumentor\Reflection\Types;
...
use const LOGLIY_T_NAME_FULLY_QUALIFIED;
use const LOGLIY_T_NAME_QUALIFIED;
...
if (!defined('LOGLIY_T_NAME_QUALIFIED')) {
    define('LOGLIY_T_NAME_QUALIFIED', 10001);
}

if (!defined('LOGLIY_T_NAME_FULLY_QUALIFIED')) {
    define('LOGLIY_T_NAME_FULLY_QUALIFIED', 10002);
}
...
final class ContextFactory
{
    ...
    private function parseNamespace(ArrayIterator $tokens): string
    {
        ...
        $name = '';
        $acceptedTokens = [T_STRING, T_NS_SEPARATOR, LOGLIY_T_NAME_QUALIFIED];
    ...
    private function skipToNextStringOrNamespaceSeparator(ArrayIterator $tokens): void
    {
        while ($tokens->valid()) {
            ...
            if ($currentToken[0] === LOGLIY_T_NAME_QUALIFIED) {
                break;
            }

            if (defined('LOGLIY_T_NAME_FULLY_QUALIFIED') && $currentToken[0] === LOGLIY_T_NAME_FULLY_QUALIFIED) {
                break;
            }
                ...
                case 'start':
                    switch ($tokenId) {
                        ...
                        case T_NS_SEPARATOR:
                            ...
                            break;
                        case LOGLIY_T_NAME_QUALIFIED:
                        case LOGLIY_T_NAME_FULLY_QUALIFIED:
                            $currentNs   .= (string) $tokenValue;
                            $currentAlias = substr(
                                (string) $tokenValue,
